...
const Ccdv = () => {
  ...
  return (
    <div className="flex flex-col items-center h-screen bg-[#040B11] p-4" ref={pageRef}>
      <h1 className="text-2xl font-bold mb-6 mt-10 text-white">Carbon Emissions Calculator</h1>
      <div className="bg-[#21e786] p-2 rounded-lg shadow-lg w-full max-w-4xl flex flex-col md:flex-row text-white">
