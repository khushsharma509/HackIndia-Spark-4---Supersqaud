    ...
    <div className="flex flex-col bg-white rounded-md">
      <div className="bg-white p-6 rounded-lg w-80">
        <div className="flex flex-col mb-4 rounded-md p-3">
          <label htmlFor="quantity " className="mb-2 font-semibold text-white">
            Quantity
          </label>
          <input 
            type="number"
        ...
        <div className="flex flex-col mb-4 p-3 rounded-md">
          <div className="flex justify-between mb-2">
            ...
            <div className="p-2 rounded text-white">{price} ETH</div>
          </div>
          <div className="flex justify-between">
            <span className="font-semibold text-white">Total</span>
            <div className="p-2 rounded text-white">{total} ETH</div>
          </div>
        </div>
