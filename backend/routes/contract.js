...
router.get('/getAll', async (req, res) => {
    try {
      ...
      for (let i = 0; i < contracts.length; i++) {
        ...
        console.log(`Fetching contract data for: ${contractAddress}`);
        try {
          ...
          console.error(`Error fetching contract data for ${contractAddress}:`, err);
          // Optionally, continue processing other contracts instead of throwing
          continue;
        }
      }
